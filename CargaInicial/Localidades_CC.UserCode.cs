...
{
    public partial class Localidades_CC
    {
        /// <summary>
        ...
        public void RenombrarArchivo()
        {
            ...
            bool existe = File.Exists(@".\Utilitarios\SalidaComando_CC.txt");
			
			try {
				if (existe)
				{
					//File.Delete(@".\Utilitarios\SalidaComando_CC.txt");
					File.Move(@".\Utilitarios\SalidaComando_CC.txt",@".\Utilitarios\SalidaComando_CC_"+ System.DateTime.Now.ToString("yyyyMMdd_hhMMss") +".txt");
        ...
        public void VerificaFinal()
        {
            ...
            try{
            	...
            	aux = File.ReadAllText(@".\Utilitarios\SalidaComando_CC.txt");
        ...
        public void LanzaCargaInicial()
        {
            ...
            p.StartInfo.Arguments = @"/C .\Utilitarios\lanzador_cc.bat";
