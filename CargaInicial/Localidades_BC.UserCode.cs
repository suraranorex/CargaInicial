...
{
    public partial class Localidades_BC
    {
        /// <summary>
        ...
        public void RenombrarArchivo()
        {
            ...
            bool existe = File.Exists(@".\Utilitarios\SalidaComando_BC.txt");
			
			try {
				if (existe)
				{
					//File.Delete(@".\Utilitarios\SalidaComando_BC.txt");
					File.Move(@".\Utilitarios\SalidaComando_BC.txt",@".\Utilitarios\SalidaComando_BC_"+ System.DateTime.Now.ToString("yyyyMMdd_hhMMss") +".txt");
        ...
        public void VerificaFinal()
        {
            ...
            try{
            	...
            	aux = File.ReadAllText(@".\Utilitarios\SalidaComando_BC.txt");
        ...
        public void LanzaCargaInicial()
        {
            ...
            p.StartInfo.Arguments = @"/C .\Utilitarios\lanzador_bc.bat";
